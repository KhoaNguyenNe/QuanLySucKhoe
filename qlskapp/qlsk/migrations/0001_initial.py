# Generated by Django 5.1.6 on 2025-05-05 13:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('expert', 'Nutritionist/Trainer')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plan_type', models.CharField(choices=[('exercise', 'Exercise'), ('diet', 'Diet')], max_length=10)),
